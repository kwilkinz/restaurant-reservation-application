...
const Seat = () => {
    ...
    const [reservation, setReservation] = useState({ people: 1 });
    ...
    const externalImage = "https://www.creativefabrica.com/wp-content/uploads/2021/09/21/Wood-Background-Wood-Texture-Background-Graphics-17652269-1-580x387.jpg"
...
const tableOptions = tables.map((table) => {
    ...
    return (
      <option 
        key={table.table_id} value={table.table_id} disabled={disabled}>
          ...
          borderRadius: "15px",
            ...
            <div className="container fluid my-3">
                ...
                <form onSubmit={handleSubmit} >
                    <label htmlFor="table_id" style={{marginRight: "10px", color: "whitesmoke"}}><h4>Seat Table: </h4></label>
                    <select
                        name="table_id"
